...
# Define __repr__, a special method that returns a string that looks like a valid Python expression that could
# be used to recreate an object with the same value. In other words, eval(repr(c)) == c
